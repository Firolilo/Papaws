    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 mb-8">
        {[
          ...
          { label: "Rescatistas",  val: rescatistas.data?.length ?? "…", color: "bg-clay-50 text-clay-500" },
          ...(puedeAccederConsultas ? [
